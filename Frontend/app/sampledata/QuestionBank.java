...
public class QuestionBank {
    ...
    public QuestionBank(Context context, ModelTestTopic topic){
        this.context=context;
        this.topic=topic;
    }
    File getTopicDir(){
        File dir=new File(context.getFilesDir(),topic.getTopic().toLowerCase());
        if(!dir.exists()) {
            dir.mkdir();
        }
        return dir;
...
//                Collections.sort(setList);
    ...
    void generateQuestionSets(List<ModelQuestion> topicAllQuestions,File dir){
